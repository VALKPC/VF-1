The STEP file, together with the [BOM](/Panels/BOM.md) and [user manual](VF-1%20User%20Manual.pdf), presents a complete set of instructions on how to build the VALKPC.
